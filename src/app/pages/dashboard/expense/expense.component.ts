...
filterData() {
  ...
  console.log("Total Money Spent (Current Month):", this.sumMoneyOutCurrentMonth);
  ...
  console.log("Total Money Spent (Previous Month):", this.sumMoneyOutPrev1Month);
  console.log("Total Money Spent (Two Months Ago):", this.sumMoneyOutPrev2Month);
  console.log("Total Money Spent (Three Months Ago):", this.sumMoneyOutPrev3Month);
  ...
  console.log("Total Money Spent (Current + Previous 3 Months):", this.sumMoneyOut);
}
